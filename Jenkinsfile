  ...
  stages {
    ...
    stage('Deploy') {
      ...
      steps {
        ...
        sh """scp -i /var/jenkins_home/.ssh/id_rsa core/target/core-0.0.1-SNAPSHOT.jar root@tindersamurai.dev:deployments/Prokurator/backend"""
        sh """scp -i /var/jenkins_home/.ssh/id_rsa CD/* root@tindersamurai.dev:deployments/Prokurator/backend"""
